...
# Initialize the Pub/Sub subscriber and publisher client
...
duplicate_data_path = publisher.topic_path(project_id, "duplicate_data")
...
def pull_messages():
    while True:
        ...
        for received_message in response.received_messages:
            ...
            if rows.one():
                publisher.publish(duplicate_data_path, data=json_data.encode('utf-8'))
                print("Order id already exists data send to duplicate queue -> ", deserialized_data)
